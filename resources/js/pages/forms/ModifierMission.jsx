...
class ModifierMission extends Component {
    constructor(props) {
        super(props);
        this.state = {
                            ...
                            <div className="form-row">
                                ...
                                <div className="col-md-3">
                                    ...
                                    <select name="demandeur_id" onChange={this.setFieldDemandeur}
                                        ...
                                        style={inputStyle}
                                        defaultValue={objetEdit.demandeur_id}
                                        className="form-control">
                                ...
                                <div className="col-md-3">
                                    <div className="position-relative form-group">
                                        ...
                                        readOnly
                                        defaultValue={objetEdit.entite_demandeur}
                                ...
                                <div className="col-md-3">
                                    <div className="position-relative form-group">
                                        ...
                                        <input name="date_demande" type="date"
                                            defaultValue={objetEdit.date_demande}
                                ...
                                <div className="col-md-2">
                                    <label className="">à</label>
                                        ...
                                        <InputMask mask="99:99" maskChar={null} 
                                            style={inputStyle}
                                            defaultValue={heure}
                                            defaultValue={objetEdit.heure_demande}
                                                ...
                                                <div className="tab-pane active" id="mission_tab" role="tabpanel">
                                                        ...
                                                        <div className="col-md-6">
                                                            <div className="position-relative form-group">
                                                                ...
                                                                <select name="nature_mission_id" onChange={this.setField}
                                                                    ...
                                                                    style={inputStyle}
                                                                    defaultValue={objetEdit.nature_mission_id}
                                                        ...
                                                        <div className="col-md-3">
                                                            <div className="position-relative form-group">
                                                                ...
                                                                <input name="moyen_transport_si_autre" type="text"
                                                                    onChange={this.setField}
                                                                    defaultValue={objetEdit.moyen_transport_si_autre}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-4">
                                                            ...
                                                            <select name="decideur_id" onChange={this.setField}
                                                                ...
                                                                style={inputStyle}
                                                                defaultValue={objetEdit.decideur_id}
                                                        ...
                                                        <div className="col-md-4">
                                                            ...
                                                            <select name="signataire_id" onChange={this.setField}
                                                                ...
                                                                style={inputStyle}
                                                                defaultValue={objetEdit.signataire_id}
                                                        ...
                                                        <div className="col-md-4">
                                                            ...
                                                            <select name="beneficiaire_principal_id" onChange={this.setField}
                                                                ...
                                                                style={inputStyle}
                                                                defaultValue={objetEdit.beneficiaire_principal_id}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="beneficiaire1_id" onChange={this.setField}
                                                             defaultValue={objetEdit.beneficiaire1_id}
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="beneficiaire2_id" onChange={this.setField}
                                                                ...
                                                                defaultValue={objetEdit.beneficiaire2_id}
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="beneficiaire3_id" onChange={this.setField}
                                                                 defaultValue={objetEdit.beneficiaire3_id}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="beneficiaire4_id" onChange={this.setField}
                                                                ...
                                                                defaultValue={objetEdit.beneficiaire4_id}
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="beneficiaire5_id" onChange={this.setField}
                                                                defaultValue={objetEdit.beneficiaire5_id}
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="beneficiaire6_id" onChange={this.setField}
                                                                defaultValue={objetEdit.beneficiaire6_id}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-3">
                                                            <div className="position-relative form-group">
                                                                ...
                                                                <input name="date_debut_misssion" type="date"
                                                                    onChange={this.setField}
                                                                    defaultValue={objetEdit.date_debut_misssion}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <InputMask mask="99:99" maskChar={null} 
                                                            style={inputStyle}
                                                            defaultValue={objetEdit.heure_debut_mission}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <InputMask mask="99:99" maskChar={null} 
                                                            style={inputStyle}
                                                            defaultValue={objetEdit.heure_fin_mission}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-3">
                                                            <div className="position-relative form-group">
                                                                <label >Pays </label>
                                                                <input name="destination_pays" type="text"
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            defaultValue={objetEdit.nombre_personne}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            defaultValue={objetEdit.description_mission}
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="prise_en_charge_cout" onChange={this.setField}
                                                                defaultValue={objetEdit.prise_en_charge_cout}
                                                        ...
                                                        <div className="col-md-3">
                                                            ...
                                                            <select name="tiers_prenant_en_charge_id" onChange={this.setField}
                                                                 defaultValue={objetEdit.tiers_prenant_en_charge_id}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="nuitees" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.nuitees}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cout_nuitee" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_nuitee}
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="repas" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.repas}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cout_repas" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_repas}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="peages" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.peages}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cout_peage" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_peage}
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="billet_de_train" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.billet_de_train}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cout_billet_train" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_billet_train}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="billet_avion" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.billet_avion}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cout_billet_avion" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_billet_avion}
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="taxis" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.taxis}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cou_billet_taxis" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cou_billet_taxis}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-1">
                                                            ...
                                                            <input name="billet_transport_commun" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.billet_transport_commun}
                                                        ...
                                                        <div className="col-md-2">
                                                            ...
                                                            <input name="cout_bilet_transport_commun" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_bilet_transport_commun}
                                                        ...
                                                        <div className="col-md-2">
                                                            <input name="frais_divers" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.frais_divers}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-1">
                                                            <input name="puissance_vehicule_cv" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.puissance_vehicule_cv}
                                                        ...
                                                        <div className="col-md-1">
                                                            <input name="kilometre_parcouru" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.kilometre_parcouru}
                                                        ...
                                                        <div className="col-md-1">
                                                            <input name="cout_unitaire_kilometre" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_unitaire_kilometre}
                                                        ...
                                                        <div className="col-md-1">
                                                            <input name="cout_total_kms" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_total_kms}
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="col-md-3">
                                                            <input name="cout_total_mission" type="number"
                                                                onChange={this.setField}
                                                                defaultValue={objetEdit.mission_couts.cout_total_mission}
...
export default connect(mapStateToProps)(ModifierMission)
