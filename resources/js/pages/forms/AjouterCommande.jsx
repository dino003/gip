                            ...
                            <div className="form-row">
                                ...
                                <div className="col-md-3">
                                    ...
                                    <select name="type_commande" onChange={this.setFieldTypeCommande}
                                        ...
                                        defaultValue={this.state.type_commande}
                                        className="form-control">
                                            ...
                                            <div className="tab-content">
                                                ...
                                                <div className="tab-pane" id="contenu_commande" role="tabpanel">
                                                    ...
                                                    {!this.state.showContenuForm && <table className="mb-0 table">
                                                        ...
                                                        <tbody>
                                                            {this.state.contenu_commandes.map((contenu, index) => <tr key={contenu.contenu_libelle_commande}>
                                                                ...
                                                                <td>
                                                                    <span onClick={() => 
                                                                         this.setState({
                                                                             contenu_commandes: this.state.contenu_commandes.splice(index, 1)
                                                                         }, () => console.log(this.state.contenu_commandes))
                                                                        //console.log(index)
                                                                     }
