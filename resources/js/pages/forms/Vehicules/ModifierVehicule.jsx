                                        ...
                                        <div className="card-body"><h5 className="card-title">Fichier des véhicules
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="entite_comptable"
                                                     style={inputStyle}
                                                     defaultValue={objetEdit.entite_comptable ? objetEdit.entite_comptable.id : null}
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="entite_physique"
                                                            style={inputStyle}
                                                            defaultValue={objetEdit.entite_physique ? objetEdit.entite_physique.id : null}
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-2">
                                                    ...
                                                    defaultValue={objetEdit.mode_acquisition_etat_vehicule}
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="demandeur"
                                                        defaultValue={objetEdit.demandeur ? objetEdit.demandeur.id : null}
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-3">
                                                    <div className="position-relative form-group">
                                                        ...
                                                        <input name="code_modele"
                                                            style={inputStyle}
                                                            defaultValue={objetEdit.code_modele}
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="categorie"
                                                        style={inputStyle}
                                                        defaultValue={objetEdit.categorie ? objetEdit.categorie.id : null}
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="marque"
                                                         style={inputStyle}
                                                         defaultValue={objetEdit.marque ? objetEdit.marque.id : null}
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="energie"
                                                            style={inputStyle}
                                                            defaultValue={objetEdit.energie ? objetEdit.energie.id : null}
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    defaultValue={objetEdit.chauffeur_atitre ? objetEdit.chauffeur_atitre.id : null}
                                                ...
                                                <div className="col-md-3">
                                                    ...
                                                    <select name="detenteur"
                                                        ...
                                                        defaultValue={objetEdit.detenteur ? objetEdit.detenteur.id : null}
                                                        className="form-control">
                                                        <option value={null}></option>
                                                        {this.props.personnels.map(per =>
                                                            <option key={per.id} value={per.id}>{per.nom} {per.prenom}</option>
