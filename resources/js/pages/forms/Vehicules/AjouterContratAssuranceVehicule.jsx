...
const formatOptionVehicule = data => (
 ...
 class AjouterContratAssuranceVehicule extends Component {
    constructor(props) {
        super(props);
        this.state = {
      ...
      enregistrerContratAssurance = (e) => {
        e.preventDefault()
          ...
          if(this.verificationFormulaire() == null){
            ...
            axios.post('/api/ajouter_contrat_assurance_pour_vehicule', contrat)
            .then(response => {
        ...
        return (
            <div className="app-main__inner">
                    ...
                    <div className="main-card mb-3 card">
                        ...
                        <h5 className="card-title">Création de Contrat d'assurance
                            ...
                            <form className="" onChange={this.setField}  onSubmit={this.enregistrerContratAssurance}>
                                ...
                                <div className="col-md-3">
                                        ...
                                        getOptionLabel={option => `${option.code}_${option.nom}`}
                                      ...
                                      />
                                        ...
                                        {this.props.tiers.filter(ti => ti.type_tiers == "COURSIER").map(tier =>
                                                <option key={tier.id} value={tier.id}>{tier.code}_{tier.nom} </option>
...
export default connect(mapStateToProps)(AjouterContratAssuranceVehicule)
