...
import "react-loader-spinner/dist/loader/css/react-spinner-loader.css"
 ...
 class AjouterBudgetEntite extends Component {
    ...
    componentDidMount(){
        this.setState({
            objetEdit: this.props.budget_entites.find(bud => bud.id == this.props.match.params.budget_entite_id)
        })
    }
      ...
      enregistrerIntervention = (e) => {
        e.preventDefault()
          ...
          if(this.verificationFormulaire() == null){
            axios.post('/api/modifier_budget_entite/' + this.state.objetEdit.id, {
            ...
            .then(response => { 
               const action = {type: "EDIT_BUDGET_ENTITE", value: response.data}
