...
// import '../../components/Tree.scss'
 ...
 class PlanGeographique extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            premier_niveau_structure_geographique: this.props.structure_geographiques[0] || null,
    ...
    ajouterEnfant(element){
      //  var plan = this.props.plan_geographiques.find(pl => pl.id == element.id)
      var structure_geographique = element.structure_geographique ? element.structure_geographique : this.props.structure_geographiques.find(st => st.id == element.structure_geographique_id)
        var structure_suivante = this.props.structure_geographiques.find(st => st.niveau == Number(structure_geographique.niveau + 1))
        this.setState({
    ...
    onEditPlanEnfant(element){
        var structure_geographique = element.structure_geographique ? element.structure_geographique : this.props.structure_geographiques.find(st => st.id == element.structure_geographique_id)
        var structure_suivante = this.props.structure_geographiques.find(st => st.niveau == Number(structure_geographique.niveau ))
        this.setState({
        ...
        if(conf === true){
            if(element.children && element.children.length){
                ...
                if(confirm(message) ){
                  ...
                  axios.delete('/api/supprimer_plan_geographique/' + element.id).then( _ => {
    ...
    isAjoutPossible(element){
            ...
            var structure_correspondante = this.props.structure_geographiques.find(st => st.id == element.structure_geographique_id)
   ...
   async handleSubmitFormPlanEnfant(){
           ...
           await axios.post('/api/ajouter_plan_geographique', 
               {
                   ...
                   structure_geographique_id: this.state.prochain_type.id,
    ...
    onEditSubmitPlanEnfant = (e) => {
      ...
      this.setState({isFormSubmitted: true})
        axios.post('/api/modifier_plan_geographique/' + modif.id, {
    ...
    getFirstStructure = () => {
        return this.props.structure_geographiques[0]
    }
    ...
    renderlist(){
          ...
          <tbody>
           {this.props.plan_geographiques.map((st, index) => 
      ...
      renderTree(){
        ...
        return (
         ...
         <OptionsList 
         options={this.props.plan_geographiques.filter(plan => plan.parent == null)} 
        ...
        return (
            ...
            <div className="main-card card" >
                       <div className="card-body ">
                           ...
                           <h5 className="card-title">Gestion du plan Géographique
                        ...
                        <form ref={(ref) => this.formRef = ref} className="p-3" onChange={this.setField} onSubmit={this.enregistrerPlanGeographique}>
                            <br />
                                ...
                                <div className="position-relative form-group">
                                    ...
                                    readOnly
                                    value={this.state.premier_niveau_structure_geographique.libelle}
                                       type="text" className="form-control" />
                                    </div>
...
export default connect(mapStateToProps)(PlanGeographique)
