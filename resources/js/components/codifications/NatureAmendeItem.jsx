...
export default class NatureAmendeItem extends Component {
            ...
            <tr>
              ...
              {this.state.isEdit ?
               <td><input className="form-control" autoFocus
                ref={nameInput => this.nameInput = nameInput} defaultValue={item.nature_amende} /> </td> 
              : <td onDoubleClick={this.onEdit}>{item.nature_amende}</td> }
                <td>
