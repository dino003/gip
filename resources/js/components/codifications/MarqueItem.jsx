...
export default class MarqueItem extends Component {
            ...
            <tr>
              ...
              {this.state.isEdit ?
               <td><input className="form-control" autoFocus
                ref={nameInput => this.nameInput = nameInput} defaultValue={item.nom_marque} /> </td> 
              : <td onDoubleClick={this.onEdit}>{item.nom_marque}</td> }
                <td>
