...
export default class NatureSinistreItem extends Component {
            ...
            <tr>
              ...
              {this.state.isEdit ?
               <td><input className="form-control" autoFocus
                ref={nameInput => this.nameInput = nameInput} defaultValue={item.nature_sinistre} /> </td> 
              : <td onDoubleClick={this.onEdit}>{item.nature_sinistre}</td> }
                <td>
