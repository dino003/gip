...
import {connect} from 'react-redux'
 ...
 class PlanOrganisationnelItem extends Component {
    ...
    render() {
       ...
       // const siege = this.props.structures_etablissements.find(el => el.code_regroupement == "SIEGE" && el.nom_regroupement == "SIEGE ETABLISSEMENT" && el.regroupement_appartenance == null)
        ...
        return (
            ...
            <td onDoubleClick={this.props.onEdit.bind(this, index)}>{item.structure_organisationnel ? item.structure_organisationnel.libelle : ''}</td>
...
export default connect(mapStateToProps)(PlanOrganisationnelItem)
