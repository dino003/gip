 ...
 class BudgetVehiculeItem extends Component {
    ...
    render() {
        ...
        return (
             ...
             <tr >
             <td className="sticky-col first-col" onDoubleClick={this.props.onEdit.bind(this, item.id)}>{item.annee ? item.annee.annee_budgetaire : ''}</td>

            <td className="sticky-col second-col" onDoubleClick={this.props.onEdit.bind(this, item.id)}>{item.vehicule ? item.vehicule.immatriculation : ''}</td>
 ...
 */}
            ...
            <td onDoubleClick={this.props.onEdit.bind(this, item.id)}>{item.depense_pourcentage ? `${item.depense_pourcentage}%` : 0}</td>

            <td onDoubleClick={this.props.onEdit.bind(this, item.id)}>{item.depense_reste ? formatageSomme(item.depense_reste) : 0}</td>
