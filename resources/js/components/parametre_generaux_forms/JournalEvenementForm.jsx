            ...
            <form className="" onSubmit={this.enregistrerInfoJournalEvenement}>
                        ...
                        <div className="form-row">
                            <div className="col-md-12">
                                ...
                                {!this.props.isFormJournalSubmitted ? <button type="submit" className="mt-2 btn btn-primary">Enregistrer</button> : <button disabled  className="mt-2 btn btn-warning">Merci de patienter  <i className="fa fa-spinner fa-spin fa-1x fa-fw"></i></button>}
