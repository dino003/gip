...
function ModeleVehiculeReducer(state = initialState, action){
    let nextState

    switch (action.type) {
        case 'ADD_MODELE_VEHICULE':
...
export default ModeleVehiculeReducer
