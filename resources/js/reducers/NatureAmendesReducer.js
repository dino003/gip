...
function NatureAmendesReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_NATURE_AMENDE':
...
export default NatureAmendesReducer
