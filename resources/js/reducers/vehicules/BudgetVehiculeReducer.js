...
function BudgetVehiculeReducer(state = initialState, action){
    let nextState

    switch (action.type) {
      
        case 'ADD_BUDGET_VEHICULE':
...
export default BudgetVehiculeReducer
