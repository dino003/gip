...
function UtilisationReducer(state = initialState, action){
    let nextState

    switch (action.type) {
      
        case 'ADD_UTILISATION':
...
export default UtilisationReducer
