...
function ContratAssuranceReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_CONTRAT_ASSURANCE':
...
export default ContratAssuranceReducer
