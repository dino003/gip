...
function NatureEnergieReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_NATURE_ENERGIE':
...
export default NatureEnergieReducer
