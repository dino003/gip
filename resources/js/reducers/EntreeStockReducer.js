...
function EntreeStockReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_ENTREE_STOCK':
...
export default EntreeStockReducer
