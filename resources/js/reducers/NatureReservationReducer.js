...
function NatureReservationReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_NATURE_RESERVATION':
            ...
            case 'REMOVE_NATURE_RESERVATION': 
...
export default NatureReservationReducer
