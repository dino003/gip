...
function TypeEntiteReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_TYPE_ENTITE':
...
export default TypeEntiteReducer
