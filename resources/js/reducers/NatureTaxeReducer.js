...
function NatureTaxeReducer(state = initialState, action){
    let nextState

    switch (action.type) {
        case 'ADD_NATURE_TAXE':
...
export default NatureTaxeReducer
