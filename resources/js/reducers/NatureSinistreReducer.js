...
function NatureSinistreReducer(state = initialState, action){
 
    let nextState

    switch (action.type) {
        case 'ADD_NATURE_SINISTRE':
...
export default NatureSinistreReducer
