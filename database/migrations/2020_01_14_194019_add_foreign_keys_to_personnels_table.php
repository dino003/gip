...
class AddForeignKeysToPersonnelsTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('categorie', 'FK_personnel_categorie_vehicule')->references('id')->on('parametrage_codifications_categories_vehicules')->onUpdate('SET NULL')->onDelete('SET NULL');
