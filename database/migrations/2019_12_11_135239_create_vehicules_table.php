...
class CreateVehiculesTable extends Migration {
	...
	public function up()
	{
		Schema::create('vehicules', function(Blueprint $table)
		{
			...
			$table->enum('mode_acquisition', array('Achat','Leasing','Pret','Location courte','Location Longue Durée'))->nullable()->default('Achat');
			...
			$table->string('energie', 100)->nullable();
			...
			$table->float('kilometrage_acquisition', 10, 0)->default(0);
			$table->float('kilometrage_nouvelle_acquisition', 10, 0)->default(0);
