...
class VehiculeUtilisationController extends Controller
{
        ...
        // return $this->model->create($request->only($this->model->getModel()->fillable));
         ...
         $creation = $utilisation->create($request->only($utilisation->fillable));
            ...
            'demandeur', 'categorie', 'marque', 'tiers', 'detenteur',
             'chauffeur_atitre', 'contrat_assurance.compagnie_assurance', 'energie'])->find($creation->vehicule);
    ...
    public function update(Request $request, $id)
    {
       ...
       $vehicule = Vehicule::with(['entite_comptable', 'entite_physique',
       'demandeur', 'categorie', 'marque', 'tiers', 'detenteur',
       'chauffeur_atitre', 'contrat_assurance.compagnie_assurance', 'energie'])->find($vehicule->id);
    ...
    public function update_derniere(Request $request, $id)
    {
       ...
       // soustraction
        ...
        $vehicule->save();
            ...
            $vehicule = Vehicule::with(['entite_comptable', 'entite_physique',
            'demandeur', 'categorie', 'marque', 'tiers', 'detenteur',
            'chauffeur_atitre', 'contrat_assurance.compagnie_assurance', 'energie'])->find($utilisation_edite2->vehicule);
    ...
    // else
            ...
            $vehicule = Vehicule::with(['entite_comptable', 'entite_physique',
            'demandeur', 'categorie', 'marque', 'tiers', 'detenteur',
            'chauffeur_atitre', 'contrat_assurance.compagnie_assurance', 'energie'])->find($utilisation_edite->vehicule);
